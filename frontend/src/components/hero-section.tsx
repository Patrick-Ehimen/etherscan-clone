...
export default function HeroSection() {
  ...
  return (
    <section className={styles.heroSectionContainer}>
      {showResult && (
        <section>
          <section className={`${styles.latestResults_header} mx-10`}>
            <section>
            ...
            <section>
              <section className={styles.hero_averageValue}>
                ...
                <Image src={charts} alt="Chart" className={styles.chart} />
              </section>
            </section>
          </section>
          <section className={`${styles.latestResults_body} m-10`}>
            <section>
